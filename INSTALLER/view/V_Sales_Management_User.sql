...
SELECT
  ...
  Master.sales_target 
FROM
  `#Project-id#.#data-Ware-house#.Sales_Target_User_Master` AS Master
LEFT JOIN
  `#Project-id#.#data-Ware-house#.User` AS SFA
ON
...
FROM
  `#Project-id#.#data-Ware-house#.Opportunity` AS OP  --SFA.OppotunitySnapshot_*から変更
LEFT JOIN
  `#Project-id#.#data-Ware-house#.User` AS SFA
ON
  OP.id = SFA.id
